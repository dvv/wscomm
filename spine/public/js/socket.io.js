...
console.log('DVV:ONPACKET', packet, this.socket);
...
var events = {
  ...
  Socket.prototype.$emit = io.EventEmitter.prototype.emit;
...
console.log('DVV:ONEVENT', packet, params, dataAck, socket);
        if (dataAck) params.push(ack);
        socket.$emit.apply(socket, params);
        break;
